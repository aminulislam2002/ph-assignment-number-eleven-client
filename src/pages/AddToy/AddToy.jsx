...
const AddToy = () => {
  ...
  const handleAddToy = (event) => {
    ...
    fetch("https://ph-assignment-number-eleven-server.vercel.app/toy", {
      method: "POST",
      headers: {
  ...
  return (
    <div className="py-10 my-10 mx-20 bg-gradient-to-r from-purple-500 via-pink-500 to-red-500 shadow-lg rounded-lg">
        ...
        <div className="grid grid-cols-3 gap-3">
          ...
          <div className="form-control">
            ...
            <div className="input-group">
              <select
                name="category"
                className="select select-bordered w-10/12 mx-auto py-2 px-3 mt-1 rounded-lg focus:ring-blue-500 focus:border-blue-500"
              >
